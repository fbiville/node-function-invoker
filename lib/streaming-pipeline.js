...
const OutputMarshaller = require('./marshalling/output-marshaller');
const logger = require('util').debuglog('riff');
const InputUnmarshaller = require('./marshalling/input-unmarshaller');
...
module.exports = class StreamingPipeline extends Writable {
    ...
    _write(inputSignal, _, callback) {
        ...
        if (inputSignal.hasStart()) {
            ...
            this._wireInputs(inputStreamNames.length);
