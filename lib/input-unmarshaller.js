...
module.exports = class InputUnmarshaller extends Transform {
    ...
    _transform(inputSignal, _, callback) {
        ...
        sensitiveLogger(`Received payload ${rawPayload} for input #${inputIndex} with content-type ${contentType}`);
        ...
        try {
            ...
            sensitiveLogger(`Payload after argument transformation: ${finalPayload} (input #${inputSignal})`);
        } catch (err) {
